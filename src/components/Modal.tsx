...
export default ({ children, title, onSave, onCancel, show }: ModelProps) =>
  ReactDOM.createPortal(
    ...
    >
      ...
      <div className="modal-container bg-white w-11/12 md:w-6/12 mx-auto rounded shadow-lg z-50 overflow-y-auto">
        ...
        <div className="modal-content py-4 text-left px-6">
          ...
          <div className="flex justify-end pt-2">
            <PrimaryBtn label="create" name="create" onClickEvent={onSave} />
            <SecondaryBtn
              label="cancel"
              name="cancel"
